...
class Tests {
    ...
    fun isNumberHappy() {
        ...
        assertFalse(isNumberHappy(7000))
    }
    ...
    fun queenThreatens() {
        ...
        assertFalse(queenThreatens(1, 1, 2, 3))
    }
    ...
    fun daysInMonth() {
        ...
        assertEquals(31, daysInMonth(12, 53))
    }
    ...
    fun circleInside() {
        ...
        assertTrue(circleInside(2.0, 3.0, 3.0, 3.0, 3.0, 7.0))
    }
    ...
    fun brickPasses() {
        ...
        assertFalse(brickPasses(1, 8, 5, 3, 1))
        assertTrue(brickPasses(3, 2, 1, 1, 2))
        assertFalse(brickPasses(10, 15, 5, 20, 2))
    }
}